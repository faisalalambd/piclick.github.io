                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body mbl-label">
                                                ...
                                                <div class="row" style="margin-bottom: 20px;margin-top:20px">
                                                    ...
                                                    <div class="col-12">
                                                        <input type="text" name="keywords" class="input no-outline" placeholder="Keyword1,keyword2,keyword3...">
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <div class="navbar-nav mr-auto py-0 ">
                            ...
                            <a href="#" class="nav-item nav-link large-display pri_hover" style="padding-top:21px;" data-toggle="modal" data-target="#upload_modal">Upload</a>
                        ...
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                            ...
                            ?>
                                ...
                                <div class="dropdown-menu dropdown-list dropdown-menu-right pullDown" style="width: 300px; border-radius: 5px;">
                                    ...
                                    <!--    <a href="#"><span style="color:#28a745; text-decoration:none;">View All </span><i class="fas fa-chevron-right" style="color:#28a745" ;></i></a>-->
                                    <!--</div>-->
                                </div>
                                </li>
