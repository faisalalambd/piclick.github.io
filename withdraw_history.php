                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-lg-12 col-md-12 col-sm-12" style="background-color: #fff;border-radius:5px;">
                                                <div style="margin:20px 0px;">
                                                    <h4 class="text-center" style="padding:10px 0px;">Withdraw History</h4>
                                                    <p style="color:green;text-align:right"><?php echo $text?></p>
                                                      ...
                                                      $sl=0;
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td> <?php echo $row['withdrawal_ammount']?> </td>
